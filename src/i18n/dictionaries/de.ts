...
const de: Dictionary = {
  ...
  common: {
    ...
    workInProgressBadge: "In Bearbeitung",
    workInProgressNotice: "Dieser Bereich befindet sich in Bearbeitung — Inhalte und Abläufe können unvollständig sein oder sich ohne Vorankündigung ändern.",
  },
