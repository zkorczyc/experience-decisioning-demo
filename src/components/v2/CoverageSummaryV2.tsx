  ...
  return (
    <Well>
      ...
      <Text UNSAFE_style={{ fontSize: "13px", color: "var(--spectrum-global-color-gray-700)", display: "block", marginTop: 4 }}>
        Every combination of traits, and what Adobe would choose — useful for exploring the full decision logic
        beyond the one scenario you're actively steering above.
      </Text>
